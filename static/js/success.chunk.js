...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true}!./node_modules/eslint-loader/index.js?{\"eslintPath\":\"/Users/wuchengqi/ican/node_modules/eslint/lib/api.js\"}!./src/router/validate/ValidatePage.js":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib?{"cacheDirectory":true}!./node_modules/eslint-loader?{"eslintPath":"/Users/wuchengqi/ican/node_modules/eslint/lib/api.js"}!./src/router/validate/ValidatePage.js ***!
  \********************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _ValidateContent = __webpack_require__(/*! ./ValidateContent */ "./src/router/validate/ValidateContent.js");

var _ValidateContent2 = _interopRequireDefault(_ValidateContent);

var _EmailToken = __webpack_require__(/*! ./EmailToken */ "./src/router/validate/EmailToken.js");

var _EmailToken2 = _interopRequireDefault(_EmailToken);
...
__webpack_require__(/*! css/register/validate.scss */ "./src/css/register/validate.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ValidatePage = function (_Component) {
    (0, _inherits3.default)(ValidatePage, _Component);

    function ValidatePage() {
        (0, _classCallCheck3.default)(this, ValidatePage);
        return (0, _possibleConstructorReturn3.default)(this, (ValidatePage.__proto__ || Object.getPrototypeOf(ValidatePage)).apply(this, arguments));
    }

    (0, _createClass3.default)(ValidatePage, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '' + match.path, component: _ValidateContent2.default }),
                _react2.default.createElement(_reactRouterDom.Route, { path: match.path + '/emailToken', component: _EmailToken2.default }),
...
/***/ "./node_modules/css-loader/index.js?{\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null,null]}!./node_modules/sass-loader/lib/loader.js!./src/css/register/validate.scss":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader?{"importLoaders":1}!./node_modules/postcss-loader/lib?{"ident":"postcss","plugins":[null,null]}!./node_modules/sass-loader/lib/loader.js!./src/css/register/validate.scss ***!
  \***********************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".flex, .flex-center, .flex-column-center, .center, .token-form .token-code > a, .flex-horizontal-center, .flex-vertical-center, .success-tip, .token-form .token-code, .flex-left-right, .flex-top-column-bottom, .register-bg, .token-way {\n  display: -ms-flexbox;\n  display: flex; }\n\n.flex-center, .flex-column-center, .center, .token-form .token-code > a {\n  -ms-flex-pack: center;\n      justify-content: center;\n  -ms-flex-align: center;\n      align-items: center; }\n\n.flex-horizontal-center {\n  -ms-flex-pack: center;\n      justify-content: center; }\n\n.flex-vertical-center, .success-tip, .token-form .token-code {\n  -ms-flex-align: center;\n      align-items: center; }\n\n.flex-column-center {\n  -ms-flex-direction: column;\n      flex-direction: column; }\n\n.flex-left-right, .flex-top-column-bottom, .register-bg {\n  -ms-flex-pack: justify;\n      justify-content: space-between; }\n\n.flex-top-column-bottom, .register-bg {\n  -ms-flex-direction: column;\n      flex-direction: column; }\n\n.register-bg {\n  z-index: -1;\n  width: 100%;\n  height: 100%;\n  background-image: url(" + __webpack_require__(/*! ../../images/common/bg.png */ "./src/images/common/bg.png") + ");\n  background-repeat: no-repeat;\n  background-size: cover;\n  padding: 20px; }\n\n.register-content {\n  min-width: 500px;\n  max-width: 1000px;\n  width: 52%;\n  height: 600px;\n  background-color: #efefef;\n  border-radius: 5px; }\n\n.topbar {\n  background-color: #000000;\n  border-radius: 5px 5px 0 0;\n  height: 12px;\n  width: undefined;\n  height: 12px; }\n\n.register-title {\n  font-size: 34px;\n  color: #000000;\n  margin: 38px 0;\n  text-align: center; }\n\n.register-success-form > div {\n  width: 405px; }\n\n.success-tip img {\n  margin-right: 17px;\n  width: 40px;\n  height: 40px; }\n\n.success-tip span {\n  font-size: 20px;\n  color: #333333; }\n\n.success-token {\n  padding-left: 57px; }\n\n.success-token > div:first-child {\n  margin: 22px 0; }\n\n.token-way {\n  margin: 20px 0; }\n  .token-way a {\n    width: 130px;\n    height: 38px;\n    color: #ffffff;\n    font-size: 16px;\n    background-color: #5aa600;\n    text-decoration: none;\n    margin: 0 9px; }\n  .token-way .token-active {\n    background-color: #9a9a9a; }\n\n.token-form {\n  font-size: 16px; }\n  .token-form > input {\n    width: 370px;\n    height: 38px;\n    padding: 12px 11px 9px;\n    font-size: 16px; }\n    .token-form > input[type='email'] {\n      margin-bottom: 20px; }\n  .token-form .token-code {\n    margin: 20px 0; }\n    .token-form .token-code > input {\n      width: 100px;\n      height: 38px;\n      margin-right: 20px;\n      padding: 12px 11px 9px; }\n    .token-form .token-code > a {\n      width: 100px;\n      height: 38px;\n      background-color: #5aa600;\n      color: #ffffff;\n      text-decoration: none; }\n  .token-form .token-submit {\n    width: 100px;\n    height: 38px;\n    background-color: #5aa600;\n    color: #ffffff;\n    font-size: 16px;\n    padding: 0; }\n\n.token-form-success .token-submit {\n  width: 100px;\n  height: 38px;\n  font-size: 16px;\n  color: #fefefe;\n  border-radius: 0.5px;\n  background-color: #428bca;\n  -webkit-box-shadow: inset 0px 1px 1px 0 rgba(1, 1, 1, 0.15);\n          box-shadow: inset 0px 1px 1px 0 rgba(1, 1, 1, 0.15);\n  border: solid 1px #cccccc;\n  margin-top: 20px; }\n", ""]);
...
/***/ "./src/css/register/validate.scss":
/*!****************************************!*\
  !*** ./src/css/register/validate.scss ***!
  \****************************************/
/*! dynamic exports provided */
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--1-oneOf-2-1!../../../node_modules/postcss-loader/lib??postcss!../../../node_modules/sass-loader/lib/loader.js!./validate.scss */ "./node_modules/css-loader/index.js?{\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null,null]}!./node_modules/sass-loader/lib/loader.js!./src/css/register/validate.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept(/*! !../../../node_modules/css-loader??ref--1-oneOf-2-1!../../../node_modules/postcss-loader/lib??postcss!../../../node_modules/sass-loader/lib/loader.js!./validate.scss */ "./node_modules/css-loader/index.js?{\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null,null]}!./node_modules/sass-loader/lib/loader.js!./src/css/register/validate.scss", function() {
			var newContent = __webpack_require__(/*! !../../../node_modules/css-loader??ref--1-oneOf-2-1!../../../node_modules/postcss-loader/lib??postcss!../../../node_modules/sass-loader/lib/loader.js!./validate.scss */ "./node_modules/css-loader/index.js?{\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"plugins\":[null,null]}!./node_modules/sass-loader/lib/loader.js!./src/css/register/validate.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
	}
...
/***/ "./src/router/validate/EmailToken.js":
/*!*******************************************!*\
  !*** ./src/router/validate/EmailToken.js ***!
  \*******************************************/
/*! dynamic exports provided */
...
var _success = __webpack_require__(/*! images/register/success.png */ "./src/images/register/success.png");
...
var EmailToken = function (_Component) {
    (0, _inherits3.default)(EmailToken, _Component);

    function EmailToken() {
        (0, _classCallCheck3.default)(this, EmailToken);

        var _this = (0, _possibleConstructorReturn3.default)(this, (EmailToken.__proto__ || Object.getPrototypeOf(EmailToken)).call(this));
    ...
    (0, _createClass3.default)(EmailToken, [{
        ...
        value: function componentDidMount() {
            ...
            var parsed = this.parsedLocation(location);

            (0, _Api.userVerify)(parsed).then(function (res) {
                console.log(res);
                if (res.data.msg === '200') {
                    _this2.timer = setInterval(function () {
                        ...
                        !_this2.state.count && clearInterval(_this2.timer);
                        !_this2.state.count && _this2.callback();
                    }, 1000);
                }
            });
        }
        ...
        key: 'parsedLocation',
        value: function parsedLocation(location) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'register-success-form center' },
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('img', { src: _success2.default }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                                    '\u606D\u559C\u4F60,\u90AE\u7BB1\u9A8C\u8BC1\u6210\u529F'
...
/***/ "./src/router/validate/ValidateContent.js":
/*!************************************************!*\
  !*** ./src/router/validate/ValidateContent.js ***!
  \************************************************/
/*! dynamic exports provided */
...
var ValidateContent = function (_Component) {
    (0, _inherits3.default)(ValidateContent, _Component);

    function ValidateContent() {
        (0, _classCallCheck3.default)(this, ValidateContent);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ValidateContent.__proto__ || Object.getPrototypeOf(ValidateContent)).call(this));
        ...
        _this.changeValidate = _this.changeValidate.bind(_this);
        _this.validateHandle = _this.validateHandle.bind(_this);
        _this.validateSuccess = _this.validateSuccess.bind(_this);
        _this.inputChange = _this.inputChange.bind(_this);
        _this.getCode = _this.getCode.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(ValidateContent, [{
        key: 'changeValidate',
        value: function changeValidate(e) {
            ...
            var validateType = e.target.type;
        ...
        key: 'validateHandle',
        value: function validateHandle(e) {
            e.preventDefault();
        ...
        key: 'validateSuccess',
        value: function validateSuccess(e) {
            e.preventDefault();
        ...
        value: function getCode() {
            ...
            var state = _history2.default.location.state;

            (0, _Api.userRegister)((0, _extends3.default)({}, state, {
                // username: '1111',
                // password: '111',
                ...
                if (res.data.msg === '200') {
                    var _res$data$result = res.data.result,
                        token = _res$data$result.token,
                        code = _res$data$result.code;
        ...
        key: 'render',
        value: function render() {
            var input = this.state.type === 'phone' ? _react2.default.createElement('input', { type: 'text', name: 'phone', placeholder: '\u8F93\u5165\u624B\u673A\u53F7',
                value: this.state.phone,
                onChange: this.inputChange }) : _react2.default.createElement('input', { type: 'email', name: 'email', placeholder: '\u8F93\u5165\u90AE\u7BB1',
            ...
            var email = _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'submit', className: 'token-submit', value: '\u5B8C\u6210\u6CE8\u518C' })
            );
            var phone = _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                    'div',
                ...
                _react2.default.createElement('input', { type: 'submit', className: 'token-submit', value: '\u5F00\u59CB\u767B\u5F55' })
            );
            return _react2.default.createElement(
                'div',
                { className: 'center' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: '#phone', className: (0, _classnames2.default)({ 'center': true, 'token-active': this.state.type === 'phone' }),
                                            type: 'phone',
                                            onClick: this.changeValidate },
                                        '\u901A\u8FC7\u624B\u673A\u53F7\u9A8C\u8BC1'
                                    ),
                                    _react2.default.createElement(
                                        'a',
                                        { href: '#email', className: (0, _classnames2.default)({ 'center': true, 'token-active': this.state.type === 'email' }),
                                            type: 'email',
                                            onClick: this.changeValidate },
                                        '\u901A\u8FC7E-mail\u9A8C\u8BC1'
                                    )
                                ),
                                !this.state.phoneSuccess && !this.state.emailSuccess ? _react2.default.createElement(
                                    'form',
                                    { className: 'token-form', onSubmit: this.validateHandle },
                                    input,
                                    this.state.type === 'email' ? undefined : _react2.default.createElement(
                                        'div',
                                        { className: 'token-code' },
                                        _react2.default.createElement('input', { type: 'text', name: 'code', placeholder: '\u9A8C\u8BC1\u7801',
                                            value: this.state.code,
                                            onChange: this.inputChange }),
                                        _react2.default.createElement(
                                            'a',
                                            { href: '#', onClick: this.getCode },
                                            '\u83B7\u53D6\u9A8C\u8BC1\u7801'
                                        )
                                    ),
                                    _react2.default.createElement('input', { type: 'submit', className: 'token-submit' })
                                ) : _react2.default.createElement(
                                    'form',
                                    { className: 'token-form-success', onSubmit: this.validateSuccess },
...
exports.default = ValidateContent;
...
//# sourceMappingURL=success.chunk.js.map